 ...
 */
 ...
 // props
const props = (props: { expandButton?: boolean; id?: string; initiallyExpanded?: boolean; maxContentHeight?: number; iconSize?: string; externalToggle?: boolean; warpHeight?: boolean; }) => ({
   props: {
     props,
   },
 });
